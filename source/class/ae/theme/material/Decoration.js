 ...
 */
qx.Theme.define("ae.theme.material.Decoration",
{
  aliases : {
    decoration : "ae/decoration/Material"
  },
  ...
  decorations :
  {
    ...
    */
    "icon-arrow-right" :
    {
    	  style :
       {
         color : ["transparent",null,"transparent","arrow-gray"],
    ...
    "icon-arrow-bottom-right" :
    {
    	style :
       {
         color : [null,null,"arrow-gray","transparent"],
