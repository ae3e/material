 ...
 * 
 * @asset(ae/icon/Material/18/file/*)
 * @asset(ae/icon/Material/18/editor/*)
 * @asset(ae/icon/Material/24/editor/*)
 */
qx.Theme.define("ae.theme.material.Appearance",
{
  appearances :
  {
    /*
    ...
    */
    ...
    "dragdrop-cursor" :
    {
      style : function(states)
      {
        ...
        return {
          source : ae.theme.material.Image.URLS["cursor-" + icon],
          position : "right-top",
          offset : [ 2, 16, 2, 6 ]
        };
      }
    ...
    */
    ...
    "slidebar/button-forward" :
    {
      ...
      {
        return {
          icon : ae.theme.material.Image.URLS["arrow-" + (states.vertical ? "down" : "right")],
          minWidth:undefined,
          minHeight:undefined,
          maxWidth:states.vertical ? undefined : 40,
          maxHeight:states.vertical ? 40 : undefined
        };
      }
    },
    ...
    "slidebar/button-backward" :
    {
      ...
      {
        return {
          icon : ae.theme.material.Image.URLS["arrow-" + (states.vertical ? "up" : "left")],
          minWidth:undefined,
          minHeight:undefined,
          maxWidth:states.vertical ? undefined : 40,
          maxHeight:states.vertical ? 40 : undefined
    ...
    "table/column-button" :
    {
      ...
      style : function(states)
      {
        return {
          ...
          padding : 3,
          icon : ae.theme.material.Image.URLS["select-column-order"]
        };
      }
    },
      ...
      style : function(states)
      {
        return {
          ...
          sortIcon : states.sorted ?
              (ae.theme.material.Image.URLS["table-" +
    ...
    */
    ...
    "treevirtual-folder" :
    {
      style : function(states)
      {
        return {
          icon : (states.opened ?
                  "icon/18/file/ic_folder_black_18dp.png" : "icon/18/file/ic_folder_open_black_18dp.png"),
    ...
    "treevirtual-file" :
    {
      ...
      {
        return {
          icon : "icon/18/editor/ic_insert_drive_file_black_18dp.png",
          opacity : states.drag ? 0.5 : undefined
        };
      }
    },
    ...
    "treevirtual-line" :
    {
      ...
      {
        return {
          icon : ae.theme.material.Image.URLS["treevirtual-line"]
        };
      }
    },
    ...
    "treevirtual-contract" :
    {
      ...
      {
        return {
          icon : ae.theme.material.Image.URLS["tree-minus"]
        };
      }
    },
    ...
    "treevirtual-expand" :
    {
      ...
      {
        return {
          icon : ae.theme.material.Image.URLS["tree-plus"]
        }
      }
    },
    ...
    "treevirtual-only-contract" :
    {
      ...
      {
        return {
          icon : ae.theme.material.Image.URLS["treevirtual-minus-only"]
        }
      }
    },
    ...
    "treevirtual-only-expand" :
    {
      ...
      {
        return {
          icon : ae.theme.material.Image.URLS["treevirtual-plus-only"]
        }
      }
    },
    ...
    "treevirtual-start-contract" :
    {
      ...
      {
        return {
          icon : ae.theme.material.Image.URLS["treevirtual-minus-start"]
        }
      }
    },
    ...
    "treevirtual-start-expand" :
    {
      ...
      {
        return {
          icon : ae.theme.material.Image.URLS["treevirtual-plus-start"]
        }
      }
    },
    ...
    "treevirtual-end-contract" :
    {
      ...
      {
        return {
          icon : ae.theme.material.Image.URLS["treevirtual-minus-end"]
        }
      }
    },
    ...
    "treevirtual-end-expand" :
    {
      ...
      {
        return {
          icon : ae.theme.material.Image.URLS["treevirtual-plus-end"]
        }
      }
    },
    ...
    "treevirtual-cross-contract" :
    {
      ...
      {
        return {
          icon : ae.theme.material.Image.URLS["treevirtual-minus-cross"]
        }
      }
    },
    ...
    "treevirtual-cross-expand" :
    {
      ...
      {
        return {
          icon : ae.theme.material.Image.URLS["treevirtual-plus-cross"]
        }
      }
    },
    ...
    "treevirtual-end" :
    {
      ...
      {
        return {
          icon : ae.theme.material.Image.URLS["treevirtual-end"]
        }
      }
    },
    ...
    "treevirtual-cross" :
    {
      ...
      {
        return {
          icon : ae.theme.material.Image.URLS["treevirtual-cross"]
        }
      }
    },
    ...
    */
    ...
    "splitpane/splitter/knob" :
    {
      ...
      {
        return {
          source : ae.theme.material.Image.URLS[
    ...
    */
    ...
    "menu-slidebar/button-backward" :
    {
      ...
      {
        return {
          icon : ae.theme.material.Image.URLS[
    ...
    "menu-button" :
    {
      ...
      {
        return {
          backgroundColor : states.selected ? "list-selected" : undefined,
      ...
      style : function(states)
      {
        return {
          icon : !states.checked ? undefined :
        	  ae.theme.material.Image.URLS["menu-checkbox"]
            /*ae.theme.material.Image.URLS[
    ...
    "menu-radiobutton" :
    {
      ...
      style : function(states)
      {
        return {
          icon : !states.checked ? undefined :
        	  ae.theme.material.Image.URLS["menu-radiobutton"]
            /*ae.theme.material.Image.URLS[
    ...
    */
    ...
    "virtual-selectbox/dropdown" : "list-popup",
    "virtual-selectbox/dropdown/list" : {
    	alias : "virtual-list"
    },

    "virtual-combobox" : "combobox",
    "virtual-combobox/dropdown" : "list-popup",
    ...
    */
    ...
    "scrollbar/button" :
    {
      style : function(states)
      {
        ...
        styles.icon = ae.theme.material.Image.URLS["arrow-" + icon];
    ...
    */
    "radiobutton/icon" : {
      style : function(states)
      {
        ...
        if (states.disabled && states.checked) {
          ...
          backgroundColor = "radiobutton-center";
        }
    ...
    "radiobutton":
    {
      style : function(states)
      {
        ...
        return {
          icon : ae.theme.material.Image.URLS["blank"]
        }
      }
    },
    ...
    */
    "checkbox":
    {
      ...
      style : function(states)
      {
        ...
        // Checked
        if (states.checked) {
          icon = ae.theme.material.Image.URLS["checkbox-checked"];
        // Undetermined
        } else if (states.undetermined) {
          icon = ae.theme.material.Image.URLS["checkbox-undetermined"];
        // Unchecked
        } else {
          // empty icon
          icon = ae.theme.material.Image.URLS["blank"];
    ...
    */
    ...
    "spinner/upbutton" :
    {
      ...
      style : function(states)
      {
        ...
        return {
          icon : ae.theme.material.Image.URLS["arrow-up-small"],
          decorator : decorator,
          minWidth:null,
          width: 17
        }
    ...
    "spinner/downbutton" :
    {
      ...
      style : function(states)
      {
        ...
        return {
          icon : ae.theme.material.Image.URLS["arrow-down-small"],
          decorator : decorator,
          minWidth:null,
          width: 17
        }
    ...
    */
    ...
    "selectbox/arrow" :
    {
      ...
      {
        return {
          source : ae.theme.material.Image.URLS["arrow-down"],
          paddingRight : 4,
          paddingLeft : 5
        };
      }
    ...
    */
    ...
    "combobox/button" :
    {
      ...
      style : function(states)
      {
        ...
        return {
          icon : ae.theme.material.Image.URLS["arrow-down"],
          decorator : decorator,
          padding : [0, 5],
          width: 19,
          center : true,
    ...
    */
    ...
    "datefield/button" :
    {
      ...
      {
        return {
          //icon : states.hovered ? "icon/18/editor/insert-invitation-gray.png" : "icon/18/editor/insert-invitation-black.png",
          icon : "icon/24/editor/ic_insert_invitation_black_24dp.png",
          //padding : [0, 0, 0, 3],
          backgroundColor : undefined,
          decorator : undefined,
          width: 19
    ...
    */
    ...
    "listitem" :
    {
      ...
      style : function(states)
      {
        var padding = [10, 10, 10, 14]; //Doesn't work on virtual list - padding bottom
        if (states.lead) {
          padding = [ 2, 4 , 2, 4];
        }
        if (states.dragover) {
    ...
    */
    ...
    "tree-folder/open" :
    {
      ...
      style : function(states)
      {
        return {
          source : "",
          decorator : states.opened ? "icon-arrow-bottom-right" : "icon-arrow-right",
          margin : states.opened ? [0,5,0,0] : [0,5,0,0],
          padding : states.opened ? [0,0,0,0] : [0,0,0,0],
          alignX: "left",
          width : 0,
          height : 0
        };
    ...
    "tree-folder" :
    {
      style : function(states)
      {
        ...
        return {
          padding : [2, 8, 2, 5],
          icon : states.opened ? "icon/18/file/ic_folder_black_18dp.png" : "icon/18/file/ic_folder_open_black_18dp.png",
          backgroundColor : backgroundColor,
          iconOpened : "icon/18/file/ic_folder_open_black_18dp.png",
          opacity : states.drag ? 0.5 : undefined
        };
      }
    },
    ...
    */
    ...
    "window/minimize-button" :
    {
      ...
      {
        return {
          icon : ae.theme.material.Image.URLS["window-minimize"],
          padding : [ 1, 2 ],
          cursor : states.disabled ? undefined : "pointer"
        };
      }
    ...
    "window/restore-button" :
    {
      ...
      {
        return {
          icon : ae.theme.material.Image.URLS["window-restore"],
          padding : [ 1, 2 ],
          cursor : states.disabled ? undefined : "pointer"
        };
      }
    ...
    "window/maximize-button" :
    {
      ...
      {
        return {
          icon : ae.theme.material.Image.URLS["window-maximize"],
          padding : [ 1, 2 ],
          cursor : states.disabled ? undefined : "pointer"
        };
      }
    ...
    "window/close-button" :
    {
      ...
      style : function(states)
      {
        return {
          marginLeft : 2,
          icon : ae.theme.material.Image.URLS["window-close"],
          padding : [ 1, 2 ],
          cursor : states.disabled ? undefined : "pointer"
        };
      }
    ...
    */
    ...
    "datechooser/button" :
    {
      style : function(states)
      {
        ...
        if (states.lastYear) {
          result.icon = ae.theme.material.Image.URLS["arrow-rewind"];
        } else if (states.lastMonth) {
          result.icon = ae.theme.material.Image.URLS["arrow-left"];
        } else if (states.nextYear) {
          result.icon = ae.theme.material.Image.URLS["arrow-forward"];
        } else if (states.nextMonth) {
          result.icon = ae.theme.material.Image.URLS["arrow-right"];
        }
    ...
    */
    ...
    "tabview-page/button" :
    {
      style : function(states)
      {
        ...
        return {
          ...
          decorator : decorator,
          textColor : states.disabled ? "text-disabled" : states.checked ? "tabview-button-selected" : "link",
          padding : padding,
          cursor: "pointer"
        };
      }
    ...
    "tabview-page/button/close-button" :
    {
      ...
      style : function(states)
      {
        return {
          cursor : states.disabled ? undefined : "pointer",
          icon : ae.theme.material.Image.URLS["tabview-close"]
        };
      }
    },
